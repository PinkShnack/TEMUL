...
str_grad_map = calculate_atom_plane_curvature(sublattice2, zone_vector_index, title=title,
...
str_grad_map, fittings = calculate_atom_plane_curvature(sublattice2, zone_vector_index,
