...
Code changes in this version:
    * The :python:`atom_deviation_from_straight_line_fit` function has been **corrected** and expanded. For a use case, see :ref:`Finding Polarisation Vectors <polarisation_vectors_tutorial.html#for-single-polarised-sublattices-e-g-lno>`
